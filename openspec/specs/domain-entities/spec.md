...
Defines the QueryLab domain model: the core entities, their relationships configured via EF Core Fluent API, indexed filter columns, and nullable reference type correctness.
