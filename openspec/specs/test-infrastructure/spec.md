...
Defines the xUnit test infrastructure for QueryLab: isolated PostgreSQL via Testcontainers, infrastructure validation tests for migrations/seeding/SQL capture, and the health endpoint integration test.
